...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:s="http://www.sitemaps.org/schemas/sitemap/0.9"
                xmlns:news="http://www.google.com/schemas/sitemap-news/0.9" version="1.0" exclude-result-prefixes="s">
    <xsl:template match="/">
        <html lang="en">
            <head>
                <meta charset="utf-8"/>
            ...
            <body>
                <div id="content">
                    ...
                    <p class="expl">Generated by <a href="https://roumen.it/projects/laravel-sitemap/" target="_blank"
                        ...
                        styled version xml sitemap (for Google News), sorted by update date.
                    </p>
                        ...
                        <tbody>
                            <xsl:for-each select="s:urlset/s:url">
                                <tr>
                                    ...
                                    <td>
                                        <xsl:value-of select="news:news/news:access"/>
                                    </td>
                                    <td>
                                        <xsl:value-of
