...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:s="http://www.sitemaps.org/schemas/sitemap/0.9"
                ...
                xmlns:video="http://www.google.com/schemas/sitemap-video/1.1" version="1.0" exclude-result-prefixes="s">
    <xsl:template match="/">
        <html lang="en">
            <head>
                <meta charset="utf-8"/>
                ...
                <script type="text/javascript"
                        src="https://cdn.roumen.it/repo/jquery.tablesorter/2.0.5/jquery.tablesorter.min.js"></script>
...
$('.url').click(function(){
  ...
  return false;
            ...
            <body>
                <div id="content">
                    <h2>XML Sitemap</h2>
                    <p class="expl">Generated by <a href="https://roumen.it/projects/laravel-sitemap/" target="_blank"
                                                    title="Sitemap generator for Laravel">laravel-sitemap</a>. This is
                        styled xml sitemap, sorted by update date.
                    </p>
                        ...
                        <tbody>
                            <xsl:for-each select="s:urlset/s:url">
                                <tr>
                                    ...
                                    <td>
                                        <xsl:value-of select="concat(s:priority*100,'%')"/>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <xsl:value-of
                                                select="concat(substring(s:lastmod,0,11),concat(' ', substring(s:lastmod,12,5)))"/>
                                    </td>
                                </tr>
                            </xsl:for-each>
                        </tbody>
